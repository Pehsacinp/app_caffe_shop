...
class ElevatedButtonCompanentMedium extends StatefulWidget {
  const ElevatedButtonCompanentMedium({super.key});

  @override
  State<ElevatedButtonCompanentMedium> createState() =>
      _ElevatedButtonCompanentMediumState();
}

bool _isPressed = true;

class _ElevatedButtonCompanentMediumState
    extends State<ElevatedButtonCompanentMedium> {
  @override
